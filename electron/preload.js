...
contextBridge.exposeInMainWorld('api', {
    ...
    getTraining: () => ipcRenderer.invoke('get-training'),
    saveTraining: (payload) => ipcRenderer.invoke('save-training', payload),
    getTrainingLog: () => ipcRenderer.invoke('get-training-log'),
    clearTrainingLog: () => ipcRenderer.invoke('clear-training-log'),
    synthesizeTraining: () => ipcRenderer.invoke('synthesize-training'),
